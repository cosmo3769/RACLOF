...
void loop() {
  ...
  else if ((s3 == lc) && (s4 == sc) && (s5 == sc) && (s6 == lc)) {
    go_white();
    if (breakcount > 0) {
      breakcount = 0;
    }
  ...
  else if ((s3 == sc) && (s4 == sc) && (s5 == sc) && (s6 == lc))
  {
    left_05_white();
    if (breakcount > 0) {
      breakcount = 0;
  ...
  else if ((s3 == lc) && (s4 == sc) && (s5 == sc) && (s6 == sc)) {
    right_05_white();
    if (breakcount > 0) {
      breakcount = 0;
    }
  ...
  else if ((s3 == lc) && (s4 == sc) && (s5 == lc) && (s6 == lc)) {
    left_10_white();
    if (breakcount > 0) {
      breakcount = 0;
    }
  ...
  else if ((s3 == lc) && (s4 == lc) && (s5 == sc) && (s6 == lc)) {
    right_10_white();
    if (breakcount > 0) {
      breakcount = 0;
    }
  ...
  else if ((s2 == lc) && (s3 == sc) && (s4 == sc) && (s5 == lc)) {
    left_15_white();
    if (breakcount > 0) {
      breakcount = 0;
    }
  ...
  else if ((s4 == lc) && (s5 == sc) && (s6 == sc) && (s7 == lc)) {
    right_15_white();
    if (breakcount > 0) {
      breakcount = 0;
    }
  ...
  else if ((s2 == sc) && (s3 == sc) && (s4 == sc) && (s5 == lc)) {
    left_20_white();
    if (breakcount > 0) {
      breakcount = 0;
    }
  ...
  else if ((s4 == lc) && (s5 == sc) && (s6 == sc) && (s7 == sc)) {
    right_20_white();
    if (breakcount > 0) {
      breakcount = 0;
    }
  ...
  else if ((s2 == lc) && (s3 == sc) && (s4 == lc) && (s5 == lc)) {
    left_25_white();
    if (breakcount > 0) {
      breakcount = 0;
    }
  ...
  else if ((s4 == lc) && (s5 == lc) && (s6 == sc) && (s7 == lc)) {
    right_25_white();
    if (breakcount > 0) {
      breakcount = 0;
    }
  ...
  else if ((s1 == lc) && (s2 == sc) && (s3 == sc) && (s4 == lc)) {
    left_30_white();
    if (breakcount > 0) {
      breakcount = 0;
    }
  ...
  else if ((s5 == lc) && (s6 == sc) && (s7 == sc) && (s8 == lc)) {
    right_30_white();
    if (breakcount > 0) {
      breakcount = 0;
    }
  ...
  else if ((s1 == sc) && (s2 == sc) && (s3 == sc) && (s4 == lc)) {
    left_35_white();
    if (breakcount > 0) {
      breakcount = 0;
    }
  ...
  else if ((s5 == lc) && (s6 == sc) && (s7 == sc) && (s8 == sc)) {
    right_35_white();
    if (breakcount > 0) {
      breakcount = 0;
    }
  ...
  else if ((s1 == lc) && (s2 == sc) && (s3 == lc) && (s4 == lc)) {
    left_40_white();
    if (breakcount > 0) {
      breakcount = 0;
    }
  ...
  else if ((s5 == lc) && (s6 == lc) && (s7 == sc) && (s8 == lc)) {
    right_40_white();
    if (breakcount > 0) {
      breakcount = 0;
    }
  ...
  //   INTERSECTION FOR WHITE
  if (s1 == sc && s2 == sc && s7 == sc && s8 == sc) {
    breakcount++;
    go();
    readsensors();
    if (breakcount >= 1000) { //for braking
